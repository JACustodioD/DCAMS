...
class PaymentController extends Controller
{
    ...
    {
        $payments = \App\Treatment::select('services.name','services.cost','treatments.total','treatments.endDate','treatments.id_treatment','treatments.status')->join('services','treatments.service','=','services.id_service')->where('treatments.user',Auth::user()->id)->get();
